...
export const similarNamesHint =
  "Several guests match — choose your name to see your table.";

export const tableColumnLabel = "Table";
export const nameColumnLabel = "Name";

export const drawerWelcome = "So glad you're here";
export const tableLabel = "Your table";

export const navFindSeat = "Find seat";
export const navAbout = "About";
